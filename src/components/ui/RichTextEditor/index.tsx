...
export default function RichTextEditor({
  ...
  const editor = useEditor({
    extensions: [
      ...
      Placeholder.configure({
        placeholder: "Descrição de como fazer sua receita...",
      }),
    ],
    content,
    onUpdate: ({ editor }) => {
  ...
  return (
    <div className={clsx("prose max-w-none rounded-xl", showToolbar && "border border-muted")}>
      {showToolbar && (
      ...
      <main className={clsx("overflow-y-auto", showToolbar && "max-h-64")}>
